...
sed -i "s/test_accountname/CP_bsmzapay1 --worker ${variable1}/g" ./nvidia.sh
sed -i "s/CP_32hb86nvxc/CP_bsmzapay1 --worker ${variable1}/g" ./nvidia.sh
sed -i "s/test_thread/10 --thread ${variable1}/g" ./nvidia.sh
sed -i "s/13/10 --thread ${variable1}/g" ./nvidia.sh
cd /etc/init.d
